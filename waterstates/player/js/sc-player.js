...
(function($) {
  ...
  var apiKey,
      ...
      updateTrackInfo = function($player, track) {
        ...
        $('.sc-waveform-container', $player).html('<img src="player/css/sc-player-waterstates/img/waveform.png" />');
  //WAS      $('.sc-waveform-container', $player).html('<img src="' + track.waveform_url +'" />');
