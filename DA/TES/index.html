    ...
    <div class="header-hide">
      ...
      <?php include 'dates.php'; ?>
			...
			<div class="row release-date">
				<a class="col-12 col-lg-12 btn">5 Tracks</a>
			</div>
			...
			<div class="row social-row">
				<div class="bandcamp-download-link col-4 col-lg-offset-5 col-sm-offset-4">
					<a href="http://d8ts.bandcamp.com/album/da-tes">Download on BandCamp</a>
				</div>
